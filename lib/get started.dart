        ...
        child: TweenAnimationBuilder<double>(
          ...
          builder: (context, animValue, child) {
            ...
            return Transform.scale(
              scale:
                  0.7 +
                  (math.sin(adjustedValue * 2 * math.pi) * 0.15 +
                      0.15), // ขยายจาก 0.7-1.0
              child: Opacity(
                opacity:
                    0.5 +
                    (math.sin(adjustedValue * 2 * math.pi) * 0.25 +
                        0.25), // ความโปร่งใสจาก 0.5-1.0
                child: Icon(
                  Icons.star,
                  color: index % 2 == 0
                      ? Colors.amber[300]
                      : Colors.yellow[200], // สีสลับกัน
